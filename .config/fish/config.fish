...
abbr akt     "sudo nix flake update --flake ~/.dotfiles/nixos/"
abbr yup "ya pack -u"
...
abbr inakt "sudo nixos-rebuild switch --flake ~/.dotfiles/nixos/"
...
abbr ppp "git --git-dir=$HOME/.cfg.git/ --work-tree=$HOME push -u github main"
